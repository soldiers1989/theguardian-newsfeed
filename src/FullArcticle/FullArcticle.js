...
class FullArcticle extends Component {
  ...
  loadData() {
    axios.get(`https://content.guardianapis.com/search?api-key=90d49681-1cb7-4c04-b0f6-067da9d6e6cb&ids=${this.props.history.location.pathname.substr(1)}&show-fields=all`).then(
      response => {
